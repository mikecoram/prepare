    ...
    return new Promise((resolve, reject) => {
        createSections(quiz.id).then((sections) => {
            ...
            sections.forEach((section) => {
                seq.push(createExamples(section.id, section.sectionTemplateId));
                seq.push(createQuestions(section.id, section.sectionTemplateId));
            });
...
function createQuestions(sectionId, sectionTemplateId) {
    return new Promise((resolve, reject) => {
        let questions = [];
        let seq = [];
