...
const RANDOM_STRINGS = [
    'promote', 'east', 'behave', 'unpleasant', 'spend', 'chew', 'sticky', 'temptation', 'mention', 'marathon', 'view', 'confine', 'growth', 'present', 'litigation', 'interface', 'lodge', 'incredible', 'prediction', 'hunting', 'clear', 'stubborn', 'buttocks', 'sell', 'sentence', 'illness', 'flush', 'charge', 'equinox', 'smash', 'produce', 'ballet', 'equal', 'judge', 'identity', 'nomination', 'ring', 'illustrate', 'innovation', 'member', 'decrease', 'trance', 'dribble', 'similar', 'dive', 'fog', 'participate', 'petty', 'guilt', 'fire'
];
